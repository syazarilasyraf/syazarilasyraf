$(function() {
    var GSHEET_JSON_URL = 'https://spreadsheets.google.com/feeds/list/1nZC9fU_2WVjBSm9nKWguoGym-OB4n-tJN8tv3Aua35o/1/public/values?alt=json';

    // https://docs.google.com/spreadsheets/d/1nZC9fU_2WVjBSm9nKWguoGym-OB4n-tJN8tv3Aua35o/edit?usp=sharing
...
$(document).ready(function() {
  ...
  // COLOURS ARRAY
  var colours = Array("#4285F4", "#34A853", "#FBBC05", "#EA4335"), idx;
  var i = 0;
  
  $('.colorfull span', this).each(function(index, character) {
      idx = i % 4;
      $(this).css("color", colours[idx]);
      i++;
  });

  $('.colorfull').hover(function(){
      var i2 = 0;
